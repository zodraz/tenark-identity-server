...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateClientsAsync()
    {
        ...
        //Web Client
        var tenarkControlPlaneId = configurationSection["Tenark_ControlPlane:ClientId"];
        if (!tenarkControlPlaneId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["Tenark_ControlPlane:RootUrl"].EnsureEndsWith('/');

            await CreateClientAsync(
                name: tenarkControlPlaneId,
                scopes: commonScopes,
                grantTypes: new[] { "hybrid" },
        ...
        //Web Client
        var tenarkPortalId = configurationSection["Tenark_Portal:ClientId"];
        if (!tenarkPortalId.IsNullOrWhiteSpace())
        {
